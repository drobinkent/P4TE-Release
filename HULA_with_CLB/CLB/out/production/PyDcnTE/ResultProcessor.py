...
def testFunction():
    contrrollerPortStatsFilePath = "/home/p4/Desktop/PyDcnTE/result/p0l0.json"
    portSVal= controllerSidePortStatisticsProcessor(contrrollerPortStatsFilePath)
    #print(portSVal)
    hostsideIPerfResultFilePath = "/home/p4/Desktop/PyDcnTE/testAndMeasurement/TEST_RESULTS/ECMP1-h0p0l0-h1p1l1"
