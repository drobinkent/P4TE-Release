...
class IPerfResult:
    ...
    def from_dict(obj: Any) -> 'ControllerStatistics':
        ...
        return IPerfResult(start, intervals, end)
...
class PortStats:
    ...
    def from_dict(obj: Any) -> 'PortStats':
        ...
        return PortStats(upward_port_egress_packet_counter, downward_port_egress_packet_counter, upward_port_ingress_packet_counter, downward_port_inress_packet_counter, cpu_port_ingress_packet_counter, cpu_port_egress_packet_counter)
