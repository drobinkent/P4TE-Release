...
const bit<19> EGRESS_QUEUE_DEPTH_THRESHOLD = 2;
...
const bit<8> WINDOW_DECREASE_RATIO = 16;  // this is used when there is some congestion how mnay times ^ -1 a windows will be reduced. 2 means 2 times shift. or window size half.
const bit<8> WINDOW_INCREASE_RATIO = 1;
#endif